...
import { businessMigrationProgramMap } from '../data/businessMigrationPrograms';
...
const BusinessMigration = () => {
  const { slug } = useParams();
  const program = businessMigrationProgramMap[slug];

  if (!program) {
    return <ComingSoon title="Business Migration Programme Not Found" />;
  }
