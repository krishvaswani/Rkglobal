...
const ProgramHero = ({ program }) => {
  ...
  return (
    <div className="w-full bg-gray-50 p-2 md:p-[10px]">
      <section
        className="relative isolate w-full h-[95svh] md:h-auto md:min-h-[820px] flex flex-col justify-end md:flex-row md:items-end md:justify-start py-0 md:py-8 px-0 md:px-20 rounded-[24px] md:rounded-[28px] overflow-hidden shadow-2xl "
