...
const StatsSection = () => {
  return (
    <div className="w-full bg-gray-50">
      ...
      >
        <div className="max-w-screen-xl mx-auto w-full grid grid-cols-5 sm:grid-cols-2 md:grid-cols-4 auto-rows-[150px] sm:auto-rows-[180px] md:auto-rows-[200px] lg:auto-rows-auto lg:grid-rows-[260px_260px] gap-3 sm:gap-4 md:gap-5 lg:gap-6 px-4 md:px-6 lg:px-8">
          
          {/* Card 1: 22+ Programmes (Tall) */}
          <div className="relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden col-span-5 sm:col-span-1 md:col-span-1 row-span-2 sm:row-span-1 md:row-span-2 shadow-sm border border-gray-100 group flex flex-col justify-end p-6 md:p-5 lg:p-6">
            <img 
              src={statsLeftImage} 
              alt="Investment" 
            ...
            <div className="relative z-10 mt-auto">
              <h3 className="text-[2.5rem] sm:text-6xl md:text-[3rem] lg:text-[4.5rem] font-bold text-gray-900 tracking-tight mb-1 sm:mb-2">
                <Counter value={22} suffix="+" />
              </h3>
              <p className="text-gray-900 font-medium text-[15px] sm:text-lg md:text-base lg:text-xl leading-[1.2] sm:leading-snug">
          ...
          <div className="relative overflow-hidden group rounded-[1.5rem] md:rounded-[2rem] bg-[#F2F5FF] p-4 sm:p-8 md:p-5 lg:p-8 flex flex-col items-center justify-center text-center shadow-sm col-span-1 md:col-span-1 md:row-span-1 border border-[#e8f0ff]">
            <img 
              src={officeImage} 
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-900 font-bold text-[11px] sm:text-sm md:text-xs lg:text-base leading-snug">Years in Investment Migration<br/>& RCBI Programmes</p>
            </div>
          </div>

          {/* Card 3: 24/7 Support */}
          <div className="relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden col-span-1 md:col-span-2 md:row-span-1 shadow-sm group bg-[#0c2b6b]">
            <img 
              src={supportBg} 
            ...
            <div className="relative z-10 w-full h-full flex items-center p-2 sm:p-4 md:p-6 lg:p-8">
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 w-full justify-center sm:justify-start">
                <div className="w-12 h-12 sm:w-20 sm:h-20 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center border border-white/20 flex-shrink-0">
                  <Clock size={40} className="text-white animate-pulse" />
                </div>
                <div className="text-center sm:text-left">
                  <h3 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold text-white mb-1">24/7</h3>
                  <p className="text-white/80 font-medium text-sm sm:text-xl md:text-base lg:text-xl leading-snug">Dedicated Support</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[1.5rem] md:rounded-[2rem] bg-gradient-to-tr from-[#8BAEFC] via-[#D1E0FF] to-[#F4F7FF] p-4 sm:p-8 md:p-5 lg:p-8 flex flex-col sm:flex-row items-center justify-center sm:justify-around text-center sm:text-left gap-2 sm:gap-8 md:gap-4 lg:gap-14 col-span-3 sm:col-span-1 md:col-span-2 md:row-span-1 shadow-sm overflow-hidden relative group">
            <img 
              src={Across4Image} 
              alt="Global reach" 
            ...
            <div className="relative z-10 flex flex-col text-center sm:text-left">
              <h3 className="text-[2.5rem] sm:text-5xl md:text-[2.5rem] lg:text-[4rem] leading-none font-bold text-gray-900 tracking-tight mb-1 sm:mb-2">
                Across <Counter value={4} />
              </h3>
              <p className="text-gray-900 font-bold text-[13px] sm:text-lg md:text-sm lg:text-xl">Continents Global Client Base</p>
            </div>
          </div>

          {/* Card 5: Success Driven Approach */}
          <div className="relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden bg-gradient-to-br from-[#cfdfff] to-[#AFC8FC] p-4 sm:p-6 md:p-4 lg:p-6 flex flex-col items-center justify-center text-center shadow-sm col-span-2 sm:col-span-1 md:col-span-1 md:row-span-1 border border-blue-200/50 group">
            <img 
              src={successBg} 
              alt="Success driven" 
              className="absolute inset-0 w-full h-full object-cover opacity-30 transition-transform duration-700 group-hover:scale-105 mix-blend-multiply"
