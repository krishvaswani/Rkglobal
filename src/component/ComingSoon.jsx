  ...
  return (
    <div className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden bg-white px-6 pt-32">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-[#1a3a8a] blur-[120px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-[#d4af37] blur-[120px]"></div>
      </div>

      <div className="relative z-10 text-center max-w-4xl mx-auto">
        {title && (
          <h2 className="text-xl md:text-2xl font-medium text-gray-500 mb-4 tracking-widest uppercase">
            {title}
          </h2>
        )}
        
        <h1 className="text-6xl md:text-8xl font-bold text-[#1a3a8a] mb-8 leading-tight">
